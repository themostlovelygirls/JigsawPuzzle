...
*/
export function show (detailString, enterCallBack, needCancel, animSpeed) {

    // console.log("in show enterCallBack:" + enterCallBack)
    Alert._enterCallBack = enterCallBack;
    // console.log("Alert._enterCallBack:" + Alert._enterCallBack)
    ...
    self.configAlert = function (detailString, enterCallBack, needCancel, animSpeed) {
        // console.log("in self.configAlert enterCallBack:" + enterCallBack)
